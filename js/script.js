...
left auto
#container {
    display: flex; /*makes container flex box*/
    flex = flow: boerder - box;
    margin - right: auto;
    margin - left: auto;
    max - width;150 px;
}
...
This can also be written like shown below, and is still considered valid format, but
for testing stick to using the single line version.
...
.row: after {
    ...
    .navbar {
        ...
        $('module-nav').on("click", function() {
            ...
            $(allModulesCardsSelector).removeClass("card-hihglight")
            $(thisModuleCardsSelector).addClass("card-hihglight")
        });
